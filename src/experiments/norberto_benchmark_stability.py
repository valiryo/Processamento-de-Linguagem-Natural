...
DEFAULT_RESULTS_PATH = PROJECT_ROOT / "results" / "norberto_benchmark_1024.csv"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "checkpoints" / "norberto_benchmark_1024"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--history-output",
        type=Path,
        default=PROJECT_ROOT / "results" / "norberto_benchmark_1024_history.csv",
    )
...
def main() -> int:
    ...
    print("=" * 72)
    print("NORBERTO — BENCHMARK OPERACIONAL")
    print("=" * 72)
