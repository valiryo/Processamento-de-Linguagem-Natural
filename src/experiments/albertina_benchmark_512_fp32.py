...
DEFAULT_RESULTS_PATH = PROJECT_ROOT / "results" / "albertina_benchmark_512_fp32.csv"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "checkpoints" / "albertina_benchmark_512_fp32"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--history-output",
        type=Path,
        default=PROJECT_ROOT / "results" / "albertina_benchmark_512_fp32_history.csv",
    )
...
def main() -> int:
    ...
    print("=" * 72)
    print("ALBERTINA 100M PT-BR — BENCHMARK FP32 (GAS FIX)")
    print("=" * 72)
