...
CHECKPOINTS_DIR = PROJECT_ROOT / "checkpoints" / "norberto_base_1024"

DEFAULT_CV_PATH = RESULTS_DIR / "norberto_base_1024_cv.csv"
DEFAULT_HISTORY_PATH = RESULTS_DIR / "norberto_base_1024_history.csv"
DEFAULT_OOF_PATH = RESULTS_DIR / "norberto_base_1024_oof.csv"
DEFAULT_SUMMARY_PATH = RESULTS_DIR / "norberto_base_1024_summary.csv"
...
class FixedGASTrainer(Trainer):
    """
    Workaround para ModernBERT + Trainer + gradient accumulation.

    ModernBertForSequenceClassification aceita **kwargs, mas a loss de
    classificacao e' CrossEntropyLoss(mean) e nao faz a normalizacao por
    num_items_in_batch. Com gradient accumulation, o Trainer pode inferir
    incorretamente que o modelo trata essa normalizacao.

    Forcar model_accepts_loss_kwargs=False restaura a normalizacao correta
    no Trainer.
    """
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Primeira CV cientifica do NorBERTo-base. "
...
def run_fold(
    ...
    if resume_checkpoint is not None:
        ...
        print("Treino iniciando do checkpoint base do NorBERTo.")
