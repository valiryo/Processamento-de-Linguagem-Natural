...
RESULTS_PATH = (
    ROOT_DIR
    / "results"
    / "bertimbau_length_384_cv.csv"
)

HISTORY_PATH = (
    ROOT_DIR
    / "results"
    / "bertimbau_length_384_history.csv"
)

OUTPUT_DIR = (
    ROOT_DIR
    / "output"
    / "bertimbau_length_384"
)
...
#
# Hiperparâmetros vencedores do Grid Search em max_length=256.
# Aqui alteramos apenas o comprimento da entrada.
# ============================================================
...
def executar_fold(
    ...
    # Reinicia a seed antes de cada fold.
    set_seed(SEED)
...
def main() -> None:
    ...
    # Tokenização acontece apenas uma vez.
