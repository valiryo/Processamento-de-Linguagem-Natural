...
DEFAULT_RESULTS_PATH = PROJECT_ROOT / "results" / "norberto_benchmark_1024_gasfix.csv"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "checkpoints" / "norberto_benchmark_1024_gasfix"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Benchmark operacional do NorBERTo-base com max_length=1024. "
    ...
    parser.add_argument(
        "--history-output",
        type=Path,
        default=PROJECT_ROOT / "results" / "norberto_benchmark_1024_gasfix_history.csv",
    )
...
def main() -> int:
    ...
    print("=" * 72)
    print("NORBERTO — BENCHMARK OPERACIONAL (GAS FIX)")
    print("=" * 72)
